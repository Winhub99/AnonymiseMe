...
console.log(session);
    ...
    const fetchAcceptMessage = useCallback(async()=>{
        ...
        try {
            ...
            console.error("Failed to fetch Messages settings")
    ...
    const handleSwitchChange = async( )=>{
        ...
        try {
            ...
            console.error("Failed to change message accepting status ")
        const axiosError = error as AxiosError<ApiResponse>
        toast({
            title:"Error ",
            description:axiosError.response?.data.message || "Failed to change message accepting status ",
            variant:"destructive"
        })
        }
    }
